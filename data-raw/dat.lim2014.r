dat.lim2014.1 <- read.csv("data-raw/dat.lim2014.1.csv", stringsAsFactors = T)
...
dat.lim2014.2 <- read.csv("data-raw/dat.lim2014.2.csv", stringsAsFactors = T)
...
dat.lim2014.3 <- read.csv("data-raw/dat.lim2014.3.csv", stringsAsFactors = T)
...
dat.lim2014.4 <- read.csv("data-raw/dat.lim2014.4.csv", stringsAsFactors = T)
