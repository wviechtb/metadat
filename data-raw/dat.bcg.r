...
dat.bcg <- read.table("data-raw/dat.bcg.txt", header=TRUE, stringsAsFactors=FALSE)
save(dat.bcg, file="data/dat.bcg.rda")

# same as dat.colditz1994 - included twice for backwards compatibility reasons
